...
public class PlayerMovement : MonoBehaviour, IMovementBehavior
{
    ...
    public bool Move(int xDir, int yDir, out RaycastHit2D hit)
    {
        ...
        boxCollider = currentPlayer.GetComponent<BoxCollider2D>();
    ...
    private void OnCannotMove<T>(T component)
    {
        ...
        currentPlayer.animator.SetTrigger("playerChop");
    ...
    protected IEnumerator SmoothMovement(Vector3 end)
    {
        ...
        while (sqrRemainingDistance > float.Epsilon)
        {
            ...
            Vector3 newPostion = Vector3.MoveTowards(rb2D.position, end, currentPlayer.inverseMoveTime * Time.deltaTime);
